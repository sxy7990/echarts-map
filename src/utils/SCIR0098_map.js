...
(function(root, factory) {
  ...
  echarts.registerMap('伊朗', {
      ...
      "features": [{
          ...
          "geometry": {
              "type": "MultiPolygon",
              "coordinates": [["@@´¬jQäQľFeBp{BpyS\\ÝeÅB¡yâ@ÊQĐ@ĒÊB{·Kċ ¢·ƜµpgÖŇĞǣĮŕµĜȇpËDÉÒŻÎęQó²@ÌÝæƹ¸īÉƘĭU´£ö£¯uĵ\\ćYs³fÀCNµd°¥®¹ÝFƃ®ůŒÛVeë^ÇGçad¿LJ÷ÖwĜåĲXÌ¹Àÿń§Ō_ƈÌBqĿeÏþD`ÒaHĜĹüµHEÃWa¼LǞoôÃ¾}EYfíæíĸUÏFĔ½Ś±"], ["@@®U}o®"]],
          ...
          "geometry": {
              "type": "MultiPolygon",
              "coordinates": [["@@z¬uu¯j"], ["@@ǖq§ÙZÓ"], ["@@¸vÊ_d±·QÑx[v"], ["@@²ka­B"], ["@@ÜYź´Ü^Ĝ¶ÀG¶b^f}Ú¨pø£ìTÀŰÐH¸{SåWgYsÁ«§ė¿Ë£YåPë£Ïas¥Cƫ«IÌa"], ["@@¦¢MEÏw]f"], ["@@¦|L±T"], ["@@jpou "], ["@@tĈZĶ[°vñ{UÞRĺ@gâËUČ|Ő{²gŐU²T¤|¸Yòô¶°hŐfĤUôh{²U°¢ĢRgÈ@à{ŐC¬~ ¦ŢlfÆdðÆôUÞPTÞW|±¤ßAÊl®ǎWĈŉĦ`¸ƗìÃƬâUâ@puĤqà¹V{ö»@¶|þà¶Ű¶ilÍIƗRá]ĳ·TÍÆÏ²ôãàĎiâAŚ²|¢¶nTr¤ÎxĦiaŅlfğ}úY¬ċĈçj§W{Íl}AT¥ÏCŅV{AŗTó°ÍĢ[ò½²CĊùö²n¶ĢYǖŵV·ólWy¥@¡XËm@ñX¡myX±nU°xÈCĦzP{öEWn{TñČLU´²P@¡UkQm³°kÆÍÞ¹°}VÝ²AV£°¥VAJoqåO¿săRn­À~£TčKƗËq§\\|¿qms©NÇYāCuēê×KóoD|¿¤Ǉ@nÕEÑ^©´iü¡ÚDÂ¶SlÛ¸kH¨ÍňxFÈoŐĶ²eôp²¥U£p²FŋƝfÓ[ËvıWąÉTę£¡AÿkNiÏb[·Ws¡aAÅkÓm¥PpąOkį¡ý}Ŀċ¥kÕdīKâ­V«]©V{|È»íoÿ`ÙE}Ĺ[«\\ewćÿÀgnBÔqĉnǹÞýr×~ŹÖûij"]],
          ...
          "geometry": {
              "type": "MultiPolygon",
              "coordinates": [["@@Á@iiš¸D¹vR¤g|\\®HrjÚËF"], ["@@¶Ætz²ÜRzĸŎ\\ÊÊÒÎĶÒŎC~¨Ĵ^OŦNĲĞG¦wÆÇÒ\\¤cŎLöÅcøÙ¾aºDİtÎœèZĘJò±ÁčD{H£ªÇƌóY|G}p¦e@oøĝ ×®ďİĩxÃHÕE¹Ó©Q×ķiù[ß¯©LŅµ^Ë}čyDÊntß¸Ŵ¯{Z£i»³D¥ÎÉLƽXeĽERãRi³«ïLÕwȍŕý£³ AØőUãYJ¸uxv Îp¬xV­ĆbÍLğ]iPqFªwÝ\\ùß±uzãiÁ\\sȟQJÛÉQē~¥|cÎ±¨t¬K výĂsPquìix³xãnBrNв̋H@ͬƶ͜S|¥|Hß¶ê©Jn|"]],

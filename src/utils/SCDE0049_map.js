...
(function(root, factory) {
  ...
  echarts.registerMap('德国', {
      ...
      "features": [{
          ...
          "geometry": {
              "type": "MultiPolygon",
              "coordinates": [["@@zBZYVA\\OrTjIcYAMXQbRhJ|_FIxDZJzG\\afD^OXFD\\]XKRSD^CPXhPbIvkSVILU^CaYJm\\aQMsQOKCWiCgDWVKaFYTR[PkMWMkXENDpUPmFURLNaNI^j@jIvCnYdBuZÛVeRIPChcNJ^_RgbQX"], ["@@`B¦UPEhTZDjEIQk_XmZKBQMKDSV[mSAKaOgEcH[GMoMFRZdTJPRRNhgbWPXF"]],
          ...
          "geometry": {
              "type": "MultiPolygon",
              "coordinates": [["@@NhEJjjCTNXVQ`GX_vWXHFN\\DRT|Nb^DpCjGjAJTAXTXBPIdDBxX\\MJL f\\MLOU]KFeMD_aY\\KbCvkQQjCPS{[P[A]}CYII[XQSMJWPK@OxSr@RMIMfED[xSFQ~[tAaawSaGWMQYWIyFwAsX[\\}HU^_XUFeROKDWI^MOIsGEMa@_N[B}YSBbjKV[TSAgo^fHrkAFPkPP\\NFYbRZH"], ["@@lQeSYDFXNJ"]],

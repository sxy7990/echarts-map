...
(function(root, factory) {
  ...
  echarts.registerMap('韩国', {
      ...
      "features": [{
          ...
          "properties": {
              "name": "Busan",
              "cp": [129.08757, 34.999544]
          },
          "geometry": {
              "type": "MultiPolygon",
              "coordinates": [["@@cPYTERpNZIXWRkPIOQaTMR"], ["@@@\\LFPMHA@qAMVLJQ@[_yNEQ]UDDlYFBlYNGZTNxH@N]@"], ["@@fLKveFib@RVDxELHpN`CFbUf`ZfBPNPMj\\GVD`RZTLhAbh`GXVnFH^XXCN^zXEtYdTL^GPRH^QrPhA`[LeASfKJMMYUBGNeKO]FUOo@sYaAOcQPSSgiGE_gQQJ_OeFeKRsJIKaUBcQIT_@MHJ^O@gMASOSWE@aOCJYSSSSGFcL]QEGX_GBS[HSLxa[MDgOAOcALUCCiIS]H@AH]V"]],
              "encodeOffsets": [[[132163, 35910]], [[131910, 35920]], [[131914, 35941]]]
          }
      }, {
          "type": "Feature",
          "properties": {
              "name": "Chungcheongbuk-do",
              "cp": [127.658757, 36.877544]
          },
          "geometry": {
              "type": "Polygon",
      ...
      },
      {
          ...
          "geometry": {
              "type": "MultiPolygon",
              "coordinates": [["@@pAVXnB`C@RTTJMrGDPZGRHNpC`PzS\\LXED[ZUVAPOZJnGhoC]OQfUDY[E[KEFYsQYiBMssJIge[BmI]JyeBwQYAqBiKQW[KBIiMSPcBKGeEuHYUUDuMQXUHoMSRUBmU_EMJs@aFueGagQQHMX]\\MX[NaFi\\W^SfJLERHXK^HP\\JHZ~bDPVNRA`XT`DhVAJNXBbTL`pCr\\RCbVRI\\B`TRAzVPL^BHNzCdD\\NbD"], ["@@_HMZ^fRUN_OQ"], ["@@BOsIWZlC^D"], ["@@]XZDD["]],
              "encodeOffsets": [[[129601, 34332]], [[130011, 34294]], [[129373, 34769]], [[129330, 34767]]]
          }
      }, {
          "type": "Feature",
          "properties": {
